import { createFileRoute, Link, Outlet, useNavigate, useRouterState } from "@tanstack/react-router";
  ...
  import { useIdentity, syncFromSession } from "@/lib/identity";
  import { getStoredToken, validateSession, clearStoredToken } from "@/lib/auth";
  ...
  function AccountLayout() {
    ...
    useEffect(() => {
      ...
      if (identity) return; // already have identity — all good
