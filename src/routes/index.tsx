import { useState, useEffect } from "react";
  ...
  function OnboardingPage() {
    ...
    function submit(e: React.FormEvent) {
      ...
      // Hand off to profiles.rald.cloud with the typed username pre-filled.
      // After auth, profiles redirects back with ?rald_token= and we hydrate identity.
      window.location.href = getAuthUrl("/", clean);
    }
            ...
            <form onSubmit={submit} className="mt-8 flex flex-col">
              ...
              <div className="mt-8">
                ...
                <p className="mt-3 text-center text-xs text-muted-foreground">
                  You'll verify your phone or email next, on RALD Identity.
                </p>
              </div>
            </form>
